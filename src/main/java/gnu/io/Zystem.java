...
|   Copyright 2002-2012 by Trent Jarvi tjarvi@qbang.org and others who
...
public class Zystem {
	...
	static {
		/*
		 * The rxtxZystem library uses Python code and is not included with
		 * RXTX. A seperate library will be released to avoid potential license
		 * conflicts.
		 * 
	...
	/**
	 * Constructor. Mode is taken from the java system property
	 * "gnu.io.log.mode". The available values are :
	 * <ul>
	...
	/*
	 * private native boolean nativeInit( ); private native void
	 * nativeFinalize();
	 */

	/* open and close the socket */
	/*
	 * private native boolean nativeNetInit( ); private native void
	 * nativeNetFinalize();
	 */

	/* dumping to a remote machine */
	/*
	 * public native boolean nativeNetReport( String s ); public native boolean
	 * nativeNetReportln( String s );
	 */

	/* specific to Matlab */
	/*
	 * public native boolean nativeMexReport( String s ); public native boolean
	 * nativeMexReportln( String s );
	 */
}
